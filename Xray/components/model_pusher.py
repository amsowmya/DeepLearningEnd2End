...
class ModelPusher:
    ...
    def build_and_push_bento_image(self):
        ...
        try:
            ...
            os.system(
                f"bentoml containerize {self.model_pusher_config.bentoml_service_name}:latest -t 506234360787.dkr.ecr.us-east-2.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
            )
            ...
            os.system(
                f"docker push 506234360787.dkr.ecr.us-east-2.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
            )
